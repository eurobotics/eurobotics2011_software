...
struct cmd_slavedspic_show_result {
	fixed_string_t arg0;
	fixed_string_t arg1;
};

/* function called when cmd_slavedspic_show is parsed successfully */
static void cmd_slavedspic_show_parsed(void * parsed_result, void * data)
{
	struct cmd_slavedspic_show_result *res = parsed_result;
	static uint8_t flag = 0;
	
	if(!strcmp(res->arg1, "toggledummy")){
	
		i2c_led_control(I2C_SLAVEDSPIC_ADDR, 1,flag);
		flag ^= 1;
		printf("done\r\n");
		return;
	}	
...
parse_pgm_token_string_t cmd_slavedspic_show_arg0 = TOKEN_STRING_INITIALIZER(struct cmd_slavedspic_show_result, arg0, str_slavedspic_show_arg0);
prog_char str_slavedspic_show_arg1[] = "show#toggledummy";
parse_pgm_token_string_t cmd_slavedspic_show_arg1 = TOKEN_STRING_INITIALIZER(struct cmd_slavedspic_show_result, arg1, str_slavedspic_show_arg1);

prog_char help_slavedspic_show[] = "show slavedspic status";
parse_pgm_inst_t cmd_slavedspic_show = {
	.f = cmd_slavedspic_show_parsed,  /* function to call */
	.data = NULL,      /* 2nd arg of func */
	.help_str = help_slavedspic_show,
	.tokens = {        /* token list, NULL terminated */
		(prog_void *)&cmd_slavedspic_show_arg0, 
		(prog_void *)&cmd_slavedspic_show_arg1, 
		NULL,
	},
};
...
/* this structure is filled when cmd_slavedspic_setmode1 is parsed successfully */
struct cmd_slavedspic_setmode1_result {
	fixed_string_t arg0;
	fixed_string_t arg1;
};

/* function called when cmd_slavedspic_setmode1 is parsed successfully */
static void cmd_slavedspic_setmode1_parsed(void *parsed_result, void *data)
{
...
parse_pgm_inst_t cmd_slavedspic_setmode1 = {
	.f = cmd_slavedspic_setmode1_parsed,  /* function to call */
	.data = NULL,      /* 2nd arg of func */
	.help_str = help_slavedspic_setmode1,
	.tokens = {        /* token list, NULL terminated */
		(prog_void *)&cmd_slavedspic_setmode1_arg0, 
		(prog_void *)&cmd_slavedspic_setmode1_arg1, 
		NULL,
	},
};
...
/* this structure is filled when cmd_slavedspic_setmode2 is parsed successfully */
...
static void cmd_slavedspic_setmode2_parsed(void *parsed_result,
...
parse_pgm_inst_t cmd_slavedspic_setmode2 = {
	.f = cmd_slavedspic_setmode2_parsed,  /* function to call */
	.data = NULL,      /* 2nd arg of func */
	.help_str = help_slavedspic_setmode2,
	.tokens = {        /* token list, NULL terminated */
		(prog_void *)&cmd_slavedspic_setmode2_arg0, 
		(prog_void *)&cmd_slavedspic_setmode2_arg1, 
		NULL,
	},
};
...
//prog_char str_mechboard_setmode3_arg1[] = "autobuild#prepare_build#prepare_inside";
...
prog_char str_beacon_arg1[] = "raw_mode#wt11_reset#wt11_call#wt11_close#on#off#color#opponent";
...
//	wait_traj_end(TRAJ_FLAGS_SMALL_DIST);
//	i2c_mechboard_mode_push_temple();
//	time_wait_ms(400);
