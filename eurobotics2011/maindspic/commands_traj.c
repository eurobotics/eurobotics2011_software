...
static void cmd_subtraj2_parsed(void *parsed_result, void *data)
{
	...
	else if (strcmp_P(res->arg1, PSTR("pp_near")) == 0) {
		err = strat_pickup_and_place_near_slots();
	}
...
prog_char str_subtraj2_arg1[] = "line1#line2#green#beginning#bonus#pickup_near#place_near#pp_near";
